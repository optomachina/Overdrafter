...
\set vendor_quote_offers_relation 'public.vendor_quote_offers'
...
select is(
  (
    ...
    where default_row.adrelid = :'vendor_quote_offers_relation'::pg_catalog.regclass
...
select ok(
  (
    ...
    where attribute_row.attrelid = :'vendor_quote_offers_relation'::pg_catalog.regclass
      and attribute_row.attname = :'geographic_origin_column'
      and not attribute_row.attisdropped
  ),
...
select is(
  (
    ...
    where constraint_row.conrelid = :'vendor_quote_offers_relation'::pg_catalog.regclass
...
select is(
  pg_catalog.col_description(
    :'vendor_quote_offers_relation'::pg_catalog.regclass,
    (
