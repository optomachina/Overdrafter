...
select is(
  pg_catalog.col_description(
    'public.vendor_quote_offers'::pg_catalog.regclass,
    (
...
select ok(
  (
    ...
    where procedure_row.oid = 'public.reconcile_vendor_quote_offers(uuid,jsonb,jsonb)'::pg_catalog.regprocedure
  ),
...
select ok(
  not exists (
    ...
    where procedure_row.oid =
      'public.reconcile_vendor_quote_offers(uuid,jsonb,jsonb)'::pg_catalog.regprocedure
