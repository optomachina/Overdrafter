...
select ok(
  pg_catalog.strpos(
    ...
    'api_request_quote_scoped(p_job_id, null)'
  ) > 0
...
select ok(
  (
    ...
    where offer.id = '81000000-0000-4000-8000-000000000012'
  )
  and exists (
    select 1
    from public.commercial_admin_audit_events event
    where event.action = 'commercial.quote_offer.invalidate'
      and event.target_id = '81000000-0000-4000-8000-000000000012'
  )
  and exists (
    select 1
    from public.quote_request_lanes lane
    where lane.vendor_quote_result_id = '81000000-0000-4000-8000-000000000010'
