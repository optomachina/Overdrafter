...
- verify customer drawing fallback accepts only direct OpenAI or Anthropic credentials and makes no request for provider-qualified models, OpenRouter-only configuration, or an injected OpenRouter provider
