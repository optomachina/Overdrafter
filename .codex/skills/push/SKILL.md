...
7. If push is rejected because the remote moved, use the `pull` skill, rerun verification, and push again.
...
9. Write or refresh the PR body using `.github/pull_request_template.md`.
10. Report:
   - branch name
